...
import animations.FadeOutTransition;
...
public class MainUi implements javafx.fxml.Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		list_menu.getItems().addAll("  Home", "  Artikle (+)", "  Suche starten", "  Einstellungen", "  Info");
		Platform.runLater(() -> {
	...
	private void MenuListListener(MouseEvent event) {
		...
		case 1: 
			...
			break;
		case 2: 
			loadAnchorPane(pane_data, "MainForm.fxml");
		    lbl_Title.setText("Suche starten");
		    break;
		case 3: 
			loadAnchorPane(pane_data, "ArticleSetting.fxml");
